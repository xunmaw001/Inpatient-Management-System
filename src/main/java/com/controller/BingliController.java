...
//                            bingliEntity.setBingliUuidNumber(data.get(0));                    //诊断编号 要改的
//                            bingliEntity.setBingliName(data.get(0));                    //诊断名称 要改的
...
//                            bingliEntity.setBingliFile(data.get(0));                    //诊断附件 要改的
...
//                            bingliEntity.setCreateTime(date);//时间
                        ...
                        if(bingliEntities_bingliUuidNumber.size() >0 ){
                            ...
                            return R.error(511,"数据库的该表中的 [诊断编号] 字段已经存在 存在数据为:"+repeatFields.toString());
                        }
